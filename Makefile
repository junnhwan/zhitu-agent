.PHONY: build run test lint docker-up docker-down clean eval eval-rag eval-dump-candidates eval-memory eval-mcp
...
eval: eval-rag eval-memory ## 跑全部 eval（RAG + Memory；workflow 还在路上）
